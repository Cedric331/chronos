<template>
    ...
    <BreezeAuthenticatedLayout>
            <div class="flex overflow-hidden">
                <div class="h-full w-full bg-gray-50 relative overflow-y-auto lg:m-24 m-auto">
                    <main>
                        <div class="pt-6 px-4">
                                ...
                                <div class="shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                    <div class="mb-4 flex items-center justify-between">
                                        <div>
                                            ...
                                            <span class="text-base font-normal text-gray-500">Vous trouverez ici la possibilité de définir les rotations et la liste des rotations</span>
                                        </div>
                                        <div class="flex-shrink-0">
                                                ...
                                                <div class="shadow overflow-hidden sm:rounded-lg">
                                                    <table class="min-w-full divide-y divide-gray-200">
                                                        ...
                                                        <tr v-for="rotation in indexRotation">
                                                            <td class="p-4 whitespace-nowrap text-lg font-bold">
                                                                {{ rotation.type }}
                                                            </td>
    ...
    <ModalRotation
        ...
        :isUpdate="isUpdate"
        @storeRotation="(data) => this.postRotation(data)"
        @closeModal="this.showModalRotation = false"
    />
</template>
