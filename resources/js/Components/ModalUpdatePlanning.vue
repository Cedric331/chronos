...
export default {
    ...
    data () {
        return {
            ...
            errors: null,
            radio: '1',
            isTech: this.selected[0].type === 'Iti',
            debut_journee: this.selected[0].horaires['debut_journee'] ?? null,
            debut_pause: this.selected[0].horaires['debut_pause'] ? this.selected[0].horaires['debut_pause'] : 'Pas de pause',
            fin_pause: this.selected[0].horaires['fin_pause'] ?? null,
            fin_journee: this.selected[0].horaires['fin_journee'] ?? null,
            teletravail: this.selected[0].horaires['teletravail'] ?? false,
            modalMail: false,
            rotation: null,
            rotations: []
        }
